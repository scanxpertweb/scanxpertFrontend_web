          ...
          {showRegistration ? (
            ...
            <>
              ...
              <form onSubmit={handleSendClick} className="flex flex-col gap-4">
                ...
                <button
                  type="submit"
                  disabled={sendingOtp}
                  className="bg-primaryBlue text-white font-semibold px-5 py-3 rounded-lg hover:bg-darkOrange transition-all w-full flex items-center justify-center gap-2"
                >
                  {sendingOtp ? (
                    <>
            ...
            <>
              ...
              <button
                onClick={verifyOtp}
                disabled={verifyingOtp}
                className="bg-green-500 text-white font-semibold px-5 py-3 rounded-lg hover:bg-green-600 transition-all mt-4 w-full flex items-center justify-center gap-2"
              >
                {verifyingOtp ? (
                  <>
                    <Loader2 className="h-4 w-4 animate-spin" />
